  ...
  return (
    <section id="top" className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute inset-0 bg-gradient-to-b from-white via-[#F7FAFF] to-[#EEF5FF]" />
        <div className="absolute -right-40 top-0 h-[520px] w-[520px] rounded-full bg-[radial-gradient(circle,rgba(37,99,235,0.14)_0%,rgba(37,99,235,0)_70%)]" />
        <div className="absolute -left-32 top-1/3 h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,rgba(124,92,252,0.10)_0%,rgba(124,92,252,0)_70%)]" />
        <svg
        ...
        >
          <pattern id="hero-dots" width="14" height="14" patternUnits="userSpaceOnUse">
            <circle cx="1.5" cy="1.5" r="1.5" fill="#BFD2F5" />
          </pattern>
      ...
      <div className="relative mx-auto grid max-w-[1280px] gap-14 px-6 pb-20 pt-14 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-8 lg:px-10 lg:pb-16 lg:pt-16">
        ...
        >
          ...
          >
            Pelatihan Git &amp; GitHub untuk meningkatkan kolaborasi dalam proyek
          ...
          <motion.div variants={fadeUp} transition={{ duration: 0.5, delay: 0.2 }} className="mt-10 w-full">
            <HeroFeatures />
          </motion.div>

          <motion.div variants={fadeUp} transition={{ duration: 0.5, delay: 0.25 }} className="mt-8 w-full">
            <SocialProof />
          </motion.div>
        </motion.div>
      ...
      >
        ...
        <motion.span
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full border border-[#D7E0E8] text-[#6B7280]"
        >
